#!/bin/bash
#SBATCH --job-name=isolate-grad
#SBATCH --output=logs/%j_isolate_grad_path.out
#SBATCH --error=logs/%j_isolate_grad_path.err
...
CLM_ML_NO_CHECKPOINT=1 python diags/isolate_grad_path.py
