#!/bin/bash
#SBATCH --job-name=cpu-vmap-1024
#SBATCH --output=/burg-archive/home/al4385/clm-ml-jax/logs/%j_ensemble_cpu_1024.out
#SBATCH --error=/burg-archive/home/al4385/clm-ml-jax/logs/%j_ensemble_cpu_1024.err
...
# CPU-only vmap benchmark for N=1024.
...
echo "=== benchmark_ensemble_cpu_1024.py ==="
python diags/benchmark_ensemble_cpu_1024.py

echo "=== run_ensemble_cpu_1024.sh complete ==="
