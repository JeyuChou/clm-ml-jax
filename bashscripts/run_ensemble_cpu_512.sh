#!/bin/bash
#SBATCH --job-name=cpu-vmap-512
#SBATCH --output=/burg-archive/home/al4385/clm-ml-jax/logs/%j_ensemble_cpu_512.out
#SBATCH --error=/burg-archive/home/al4385/clm-ml-jax/logs/%j_ensemble_cpu_512.err
...
# CPU-only vmap benchmark for N=512.
...
echo "=== benchmark_ensemble_cpu_512.py ==="
python diags/benchmark_ensemble_cpu_512.py

echo "=== run_ensemble_cpu_512.sh complete ==="
